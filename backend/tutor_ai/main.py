...
from tutor_ai.api.v1.chat import router as chat_router
from tutor_ai.api.v1.health import router as health_router
from tutor_ai.api.v1.metrics import router as metrics_router
from tutor_ai.dependencies import get_config
from tutor_ai.middleware import AccessLoggingMiddleware, RequestSizeMiddleware
...
if __name__ == "__main__":
    ...
    uvicorn.run("tutor_ai.main:app", host="0.0.0.0", port=8000, reload=True, access_log=False)
